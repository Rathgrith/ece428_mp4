...
type RunMapleTaskRequest struct {
	...
	ExeArgs                    []string      `protobuf:"bytes,4,rep,name=exe_args,json=exeArgs,proto3" json:"exe_args,omitempty"`
...
func (x *RunMapleTaskRequest) GetExeArgs() []string {
	if x != nil {
		return x.ExeArgs
	}
	return nil
...
type RunJuiceTaskRequest struct {
	...
	ExeArgs                []string `protobuf:"bytes,5,rep,name=exe_args,json=exeArgs,proto3" json:"exe_args,omitempty"`
}
...
func (x *RunJuiceTaskRequest) GetExeArgs() []string {
	if x != nil {
		return x.ExeArgs
	}
	return nil
...
func (x *ExecuteMapleJobRequest) GetExeArgs() []string {
	if x != nil {
		return x.ExeArgs
	}
	return nil
...
type ExecuteMapleJobResponse struct {
	...
	Code                  StatusCode `protobuf:"varint,1,opt,name=code,proto3,enum=idl.StatusCode" json:"code,omitempty"`
	IntermediateFilenames []string   `protobuf:"bytes,2,rep,name=intermediate_filenames,json=intermediateFilenames,proto3" json:"intermediate_filenames,omitempty"`
}
...
func (x *ExecuteMapleJobResponse) GetIntermediateFilenames() []string {
	if x != nil {
		return x.IntermediateFilenames
	}
	return nil
}

type ExecuteJuiceJobRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ExeName               string   `protobuf:"bytes,1,opt,name=exe_name,json=exeName,proto3" json:"exe_name,omitempty"`
	IntermediateFilenames []string `protobuf:"bytes,2,rep,name=intermediate_filenames,json=intermediateFilenames,proto3" json:"intermediate_filenames,omitempty"`
	NumMaples             int32    `protobuf:"varint,3,opt,name=num_maples,json=numMaples,proto3" json:"num_maples,omitempty"`
	OutPutFilename        string   `protobuf:"bytes,4,opt,name=out_put_filename,json=outPutFilename,proto3" json:"out_put_filename,omitempty"`
	ExeArgs               []string `protobuf:"bytes,5,rep,name=exe_args,json=exeArgs,proto3" json:"exe_args,omitempty"`
}

func (x *ExecuteJuiceJobRequest) Reset() {
	*x = ExecuteJuiceJobRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_maple_juice_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ExecuteJuiceJobRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecuteJuiceJobRequest) ProtoMessage() {}

func (x *ExecuteJuiceJobRequest) ProtoReflect() protoreflect.Message {
	mi := &file_maple_juice_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecuteJuiceJobRequest.ProtoReflect.Descriptor instead.
func (*ExecuteJuiceJobRequest) Descriptor() ([]byte, []int) {
	return file_maple_juice_proto_rawDescGZIP(), []int{9}
}

func (x *ExecuteJuiceJobRequest) GetExeName() string {
	if x != nil {
		return x.ExeName
	}
	return ""
...
func (x *ExecuteJuiceJobRequest) GetIntermediateFilenames() []string {
	if x != nil {
		return x.IntermediateFilenames
	}
	return nil
...
func (x *ExecuteJuiceJobRequest) GetNumMaples() int32 {
	if x != nil {
		return x.NumMaples
	}
	return 0
...
func (x *ExecuteJuiceJobRequest) GetOutPutFilename() string {
	if x != nil {
		return x.OutPutFilename
	}
	return ""
...
func (x *ExecuteJuiceJobRequest) GetExeArgs() []string {
	if x != nil {
		return x.ExeArgs
	}
	return nil
...
type ExecuteJuiceJobResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ExecuteJuiceJobResponse) Reset() {
	*x = ExecuteJuiceJobResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_maple_juice_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ExecuteJuiceJobResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecuteJuiceJobResponse) ProtoMessage() {}

func (x *ExecuteJuiceJobResponse) ProtoReflect() protoreflect.Message {
	mi := &file_maple_juice_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecuteJuiceJobResponse.ProtoReflect.Descriptor instead.
func (*ExecuteJuiceJobResponse) Descriptor() ([]byte, []int) {
	return file_maple_juice_proto_rawDescGZIP(), []int{10}
}

func (x *ExecuteJuiceJobResponse) GetCode() StatusCode {
	if x != nil {
		return x.Code
	}
	return StatusCode_Unknown
...
var file_maple_juice_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x09, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x53, 0x69, 0x7a, 0x65, 0x22, 0xe0, 0x01,
	...
	,
	...
	0x74, 0x22, 0x13, 0x0a, 0x11, 0x48, 0x65, 0x61, 0x72, 0x74, 0x42, 0x65, 0x61, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xd0, 0x01, 0x0a, 0x16, 0x45, 0x78, 0x65, 0x63, 0x75,
	0x74, 0x65, 0x4d, 0x61, 0x70, 0x6c, 0x65, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x78, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x65, 0x78, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x40, 0x0a, 0x1c,
	...
	,
}
...
var file_maple_juice_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_maple_juice_proto_goTypes = []interface{}{
	...
	(*RunJuiceTaskRequest)(nil),     // 3: idl.RunJuiceTaskRequest
	(*RunJuiceTaskResponse)(nil),    // 4: idl.RunJuiceTaskResponse
	(*HeartbeatRequest)(nil),        // 5: idl.HeartbeatRequest
	(*HeartBeatResponse)(nil),       // 6: idl.HeartBeatResponse
	(*ExecuteMapleJobRequest)(nil),  // 7: idl.ExecuteMapleJobRequest
	(*ExecuteMapleJobResponse)(nil), // 8: idl.ExecuteMapleJobResponse
	(*ExecuteJuiceJobRequest)(nil),  // 9: idl.ExecuteJuiceJobRequest
	(*ExecuteJuiceJobResponse)(nil), // 10: idl.ExecuteJuiceJobResponse
	(StatusCode)(0),                 // 11: idl.StatusCode
}
var file_maple_juice_proto_depIdxs = []int32{
	0,  // 0: idl.RunMapleTaskRequest.input_splits:type_name -> idl.InputSplit
	11, // 1: idl.RunMapleTaskResponse.code:type_name -> idl.StatusCode
	11, // 2: idl.RunJuiceTaskResponse.code:type_name -> idl.StatusCode
	11, // 3: idl.ExecuteMapleJobResponse.code:type_name -> idl.StatusCode
	11, // 4: idl.ExecuteJuiceJobResponse.code:type_name -> idl.StatusCode
	1,  // 5: idl.NodeManageService.RunMapleTask:input_type -> idl.RunMapleTaskRequest
	3,  // 6: idl.NodeManageService.RunJuiceTask:input_type -> idl.RunJuiceTaskRequest
	5,  // 7: idl.JobManageService.Heartbeat:input_type -> idl.HeartbeatRequest
	2,  // 8: idl.NodeManageService.RunMapleTask:output_type -> idl.RunMapleTaskResponse
	4,  // 9: idl.NodeManageService.RunJuiceTask:output_type -> idl.RunJuiceTaskResponse
	6,  // 10: idl.JobManageService.Heartbeat:output_type -> idl.HeartBeatResponse
...
func file_maple_juice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_maple_juice_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecuteJuiceJobRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_maple_juice_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecuteJuiceJobResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_maple_juice_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
